...
Measures, segments and their owners are in [`metrics.md`](metrics.md); the cases it does
*not* cover (item/category grain, attribution, marketing spend) are listed there too.
...
- Attributed revenue, ROAS, CAC, campaign cuts → [`marketing.md`](marketing.md).
